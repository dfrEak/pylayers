                ...
                if rmoutceilR:
                    ...
                    if len(uc[0]) !=0:
                        ...
                        if len(uout)>0:
                            ...
                            # make sure that col is not out of index of the signature
                            temp_col = [col for col in uc[1][uout] if (col < sigsave.shape[2])]
                            sigsave = np.delete(sigsave,temp_col,axis=2)
